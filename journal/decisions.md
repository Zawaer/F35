...
| **Door micro-servos** | SG90 on the 6 V servo rail | **4× mini 2g servo (plastic gear)** for lightweight door actuators on a dedicated **4.0 V LM2596 rail** (SG90 fallback for remaining doors) | 2g servos max 4.2 V → can't share the 6 V rail; one LM2596 buck at 4.0 V powers all 4 | [05](../docs/05-servos.md) |
