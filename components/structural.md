...
Cards for carbon tube/rod, bearings, balls, fasteners, wheels, and adhesives. See the
[template & field guide](README.md). Build context: [Materials & Airframe](../docs/09-materials-airframe.md).

> No detailed cards yet — paste each product page and I'll add a spec card here.
