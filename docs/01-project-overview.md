...
- **Airframe:** LW-PLA printed shell + carbon fibre spars. See
...
| Servo power | PDB 6V servo BEC = **7.5 A continuous** (IC-verified 2026-06-26, SCT2481) — ample, no UBEC split needed | [Power](02-power-system.md) |
