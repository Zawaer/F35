...
| 13 | [3BSM Swivel Kinematics](docs/13-3bsm-swivel-kinematics.md) | Joint chain, motion-link math, wedge-angle/symmetry trade-offs, V1 (1 motor) vs V2 (3 motors) roadmap |
